        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16 items-center">
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              <Link
                className="bg-cta text-cta-foreground hover:opacity-90 px-6 py-2.5 rounded-full text-sm font-medium shadow-lg shadow-orange-500/20 transition-all hover:scale-105 active:scale-95 flex items-center gap-2"
                href="/survey"
              >
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-background border-t border-border">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              ...
              <Link
                href="/survey"
                className="block w-full text-left px-3 py-2 rounded-lg text-base font-medium text-primary hover:bg-muted/50"
              >
                Report Pest
              </Link>
            </div>
